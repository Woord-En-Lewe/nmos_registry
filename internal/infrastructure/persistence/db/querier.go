...
type Querier interface {
	...
	IDExistsInDevices(ctx context.Context, id string) (int64, error)
	IDExistsInFlows(ctx context.Context, id string) (int64, error)
	IDExistsInNodes(ctx context.Context, id string) (int64, error)
	IDExistsInReceivers(ctx context.Context, id string) (int64, error)
	IDExistsInSenders(ctx context.Context, id string) (int64, error)
	IDExistsInSources(ctx context.Context, id string) (int64, error)
